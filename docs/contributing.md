...
Contributions are welcome. `go-ruby-rqrcode/rqrcode` is built to a small set of
...
The library is in [`github.com/go-ruby-rqrcode/rqrcode`](https://github.com/go-ruby-rqrcode/rqrcode).
This documentation site is in [`github.com/go-ruby-rqrcode/docs`](https://github.com/go-ruby-rqrcode/docs).

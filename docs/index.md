# go-ruby-rqrcode documentation

**Pure-Go (CGO=0) MRI-faithful Ruby rqrcode**

`go-ruby-rqrcode/rqrcode` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `rqrcode`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `rqrcode`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`rqrcode`](https://github.com/go-ruby-rqrcode/rqrcode) | the library — Ruby's `rqrcode` in pure Go |
| [`docs`](https://github.com/go-ruby-rqrcode/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-rqrcode.github.io`](https://github.com/go-ruby-rqrcode/go-ruby-rqrcode.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-rqrcode/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-rqrcode/rqrcode](https://github.com/go-ruby-rqrcode/rqrcode).

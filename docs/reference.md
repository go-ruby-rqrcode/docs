...
The public API lives at the module root (`github.com/go-ruby-rqrcode/rqrcode`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `rqrcode`, while the surface follows
...
```go
import "github.com/go-ruby-rqrcode/rqrcode"
```
...
- **[pkg.go.dev/github.com/go-ruby-rqrcode/rqrcode](https://pkg.go.dev/github.com/go-ruby-rqrcode/rqrcode)**

The module's [README](https://github.com/go-ruby-rqrcode/rqrcode#readme) carries worked

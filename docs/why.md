...
`go-ruby-rqrcode/rqrcode` reimplements Ruby's `rqrcode` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-rqrcode/rqrcode` directly, with no Ruby runtime;
